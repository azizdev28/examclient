...
import aboutImg from "@/image/homeimg/aboutImg.png";
const AboutPage = () => {
  return (
    <div className="container">
      <section className="max-w-[704px] mx-auto py-[67px]">
        <h2 className="text-center text-3xl font-normal leading-relaxed tracking-normal text-indigo-900">
          {" "}
      ...
      <section className="text-gray-600 body-font ">
        <div className="container mx-auto flex  md:flex-row flex-col items-center">
          <div className="lg:flex-grow lg:w-1/2 md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <div className="lg:w-1/2  w-full md:w-1/2 w-5/6">
            <Image
      ...
      <section className="text-gray-600 body-font ">
        <div className="container mx-auto flex md:flex-row flex-col items-center">
          ...
          <div className="lg:flex-grow  sm:pl-0  lg:justify-start lg:items-start lg:pl-[84px]  md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start  md:text-left mb-16 md:mb-0 items-center text-center">
            <h1 className="title-font sm:text-4xl text-3xl mb-4  font-medium text-gray-900">
              From a studio in London to a global brand with over 400 outlets
            </h1>
            <p className="mb-8 leading-relaxed">
        ...
        <div className="container px-5 py-24 mx-auto bg-white">
          <div className="flex flex-col text-center w-full mb-12">
            ...
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
              Sign up for our newsletter and receive exclusive <br /> offers on
